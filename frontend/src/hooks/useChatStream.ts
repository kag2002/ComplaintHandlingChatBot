...
const LOADING_STEPS: Array<{
  ...
  { step: 'validating', label: 'Tiếp nhận khiếu nại...', delay: 300 },
  { step: 'thinking',   label: 'Tra cứu thông tin đơn hàng...', delay: 1000 },
  { step: 'searching',  label: 'Kiểm tra bằng chứng hình ảnh...', delay: 2000 },
  { step: 'analyzing',  label: 'Phân loại tự động (Triage)...', delay: 3200 },
  { step: 'generating', label: 'Kiểm tra chính sách và an toàn...', delay: 4400 },
];
